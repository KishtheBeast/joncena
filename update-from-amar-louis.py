...
def download_website(url, output_dir="ticket-master"):
    try:
        ...
        color_css_path = os.path.join(output_dir,'color.css')
        try:
...
if __name__ == "__main__":
    ...
    if download_website(target_url):
        ...
        print("2. Start a local server: python3 -m http.server 8000")
